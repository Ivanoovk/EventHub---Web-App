...
using static EventHubApp.Data.Common.ExceptionMessages;
...
namespace EventHubApp.Data.Repository
{
    public abstract class BaseRepository<TEntity, TKey>
            ...
            where TEntity : class
    {
        protected readonly EventHubAppDbContext DbContext;
        protected readonly DbSet<TEntity> DbSet;

        protected BaseRepository(EventHubAppDbContext dbContext)
        {
