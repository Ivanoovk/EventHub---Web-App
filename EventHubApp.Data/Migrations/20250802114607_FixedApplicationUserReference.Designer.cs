...
namespace EventHubApp.Data.Migrations
{
    ...
    [Migration("20250802114607_FixedApplicationUserReference")]
    partial class FixedApplicationUserReference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventHubApp.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EventHubApp.Data.Models.ApplicationUserEvent", b =>
                {
                    b.HasOne("EventHubApp.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("WatchlistEvents")
            ...
            modelBuilder.Entity("EventHubApp.Data.Models.Ticket", b =>
                {
                    b.HasOne("EventHubApp.Data.Models.ApplicationUser", null)
                        .WithMany("Tickets")
                        .HasForeignKey("ApplicationUserId");
